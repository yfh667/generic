...
print(f"\nExtracting dataresult for time step {target_time_step} from '{dummy_file_name}'...")
...
# 遍历 distinct 的第一个子列表 (distinct[0]) 中的每个节点 ID
# 将节点 ID 作为键，demand 作为值添加到 SOURCES 字典中
...
def initialize_population():
    ...
    for i in range(population_size):
        chromosome.append ( initialize_individual(N,P,distinct) )
