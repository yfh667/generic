...
# we should next modify
    ...
    # # 注意：visibile_data 拼写保留了你原路径的写法 (visible 多了个 i)
    # BASE_DIR = Path(r"C:\usrspace\mywork\data_paper2\visibile_data")
    #
    # # ================= 2. 动态构造路径 =================
    #
    # # 构造子文件夹名: "baseRaan_0_time_7_8"
    # sub_folder = f"baseRaan_{baseRaan}_time_{time_tag}"
    #
    # # 构造文件名: "station_visible_satellites_baseRaan_0.xml"
    # file_name = f"station_visible_satellites_baseRaan_{baseRaan}.xml"
    #
    # # 拼接完整路径: 基础目录 / 子文件夹 / 文件名
    # xml_file_path = BASE_DIR / sub_folder / file_name
