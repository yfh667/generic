...
if __name__ == '__main__':
   ...
   # fitness, indictors_seq = fitness_function(P, N, T, [individual1], regions_to_color)
    ...
    fitness, indictors_seq = fitnessfuc.calculate_fitness(individual1,regions_to_color, inter_link_bandwidth, intra_link_bandwidth, cost,P, N, T )

    child1 = mutate.mutate_f(individual1,regions_to_color,inter_link_bandwidth, intra_link_bandwidth, cost,P, N, T,setuptime)
    ...
    for i in range(100):
        child1 = mutate.mutate_f(child1, regions_to_color, inter_link_bandwidth, intra_link_bandwidth, cost, P, N,  T, setuptime)
        fitness, indictors_seq = fitnessfuc.calculate_fitness(child1,regions_to_color, inter_link_bandwidth, intra_link_bandwidth, cost,P, N, T )
        print(fitness)
