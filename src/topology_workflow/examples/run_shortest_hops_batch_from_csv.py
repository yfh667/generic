...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run shortest-hop batch simulation for motif CSV topologies.")
    ...
    parser.add_argument("--library", type=str, default="combined_motif")
    ...
    parser.add_argument("--run-label", type=str, default="batch")
...
def main() -> int:
    ...
    meta = compute_shortest_hops_batch(
    ...
    print(f"[topology-workflow] shortest-hop batch written: {meta['topology_count']} topologies -> {args.out_dir}")
    return 0
