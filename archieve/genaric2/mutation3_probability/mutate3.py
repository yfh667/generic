...
#
# def disconnect2establishment(    basicSa,end,coordinate, chromosome, P, N, T,setuptime):
#     x = coordinate[0]
#     y = coordinate[1]
#     t = coordinate[2]
#     #here in fact ,basicSa=t+1
#     duration = end - basicSa+1
...
#
#
#         chromosome[(x, y, basicSa-1)].state = 0
#         chromosome[(x, y, basicSa-1)].rightneighbor =  chosen
#
#
...
#             if basicSa + i < T :
#                 chromosome[(x, y, basicSa+i)].state = 1
#                 chromosome[(x, y, basicSa + i)].rightneighbor = chosen
#
#
