...
#     """Interactive time-series visualisation for basicSa topology_prof graphs."""
#
#     _DISTINCT_COLOURS = [
#         "lightcoral",
#         "lightgreen",
...
if __name__ == "__main__":
    ...
    for t in range(1, T):
        u = (t - 1) * N
        v = t * N
        adjacency_list_array[t].append((u, v))

    region_groups_array: List[List[List[int]]] = [ [[t * N + (t % N)]] for t in range(T) ]

    vis = time_2d.DynamicGraphVisualizer(adjacency_list_array, region_groups_array, N, P)
    vis.show()