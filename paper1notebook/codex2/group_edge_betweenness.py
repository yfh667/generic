...
def edge_betweenness_between_node_sets(
    ...
    *,
    ...
    For equal-length shortest paths, one source-target pair is split fractionally
    across all shortest paths. This keeps each pair's total contribution equal to
    its shortest-path hop length.
    """
